...
- New sensor or binary_sensor entity -> `../skills/python-homeassistant/SKILL.md` + `../skills/testing-hass-iopool/SKILL.md`
- Webhook or API security work -> `../skills/python-homeassistant/SKILL.md` + `../skills/security-best-practices/SKILL.md`
