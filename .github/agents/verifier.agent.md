...
1. `../skills/testing-hass-iopool/SKILL.md` — canonical source for environment detection, pytest run commands (devcontainer vs `docker exec`), and test tiers for this project
