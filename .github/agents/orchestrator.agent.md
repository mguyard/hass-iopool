...
- Any task in `custom_components/iopool/` -> `../skills/python-homeassistant/SKILL.md` (always load first)
- New entity (sensor, binary_sensor, select) -> `../skills/python-homeassistant/SKILL.md` + `../skills/testing-hass-iopool/SKILL.md`
- Bug fix in coordinator or filtration -> `../skills/python-homeassistant/SKILL.md` + `../skills/code-quality/SKILL.md`
- Security review (API key, aiohttp) -> `../skills/python-homeassistant/SKILL.md` + `../skills/security-best-practices/SKILL.md`
- Commit / PR / pre-commit gate -> `../skills/git-conventions/SKILL.md`
- Writing or fixing tests -> `../skills/testing-hass-iopool/SKILL.md` + `../skills/testing-qa/SKILL.md`
- Documentation pages (`docs/`, `docs.json`) -> `../skills/docs-hass-iopool/SKILL.md`
...
4. **New entity creation** (sensor, binary_sensor, select) -> `Planner` if clarification needed, then `CoderSr` with `python-homeassistant/SKILL.md` + `testing-hass-iopool/SKILL.md`, then `Verifier`
5. **Code review / audit / analysis** -> `Reviewer` with `python-homeassistant/SKILL.md` + `review-core/SKILL.md`; add `security-best-practices/SKILL.md` for `config_flow.py`, `coordinator.py`, `__init__.py`; `python-homeassistant/SKILL.md §8` is the HA-specific review checklist and must always be included for any file in `custom_components/iopool/`
6. **Documentation update / new doc page** -> `CoderJr` with `docs-hass-iopool/SKILL.md`; if scope unclear, route to `Planner` first
