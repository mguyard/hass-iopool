...
### How do I enable entity name translations?

<Accordion title="Entity name translations" icon="language">
To have entity names translated, you must set the server language in your `configuration.yaml`:
...
### Can I rename integration entities IDs ?

<Accordion title="No..." icon="pen-to-square">
No, you should not rename integration entities IDs.

These IDs are used internally, especially for entity relationships and filtering mechanisms. Modifying entity IDs can lead to unexpected behavior and system instability.
__Please note that support will not be provided for issues arising from changes to entity IDs.__
</Accordion>
